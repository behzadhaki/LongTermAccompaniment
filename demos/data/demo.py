...
# =================================================================================================
from data import Groove2Groove2BarDataset

# load dataset as torch.utils.data.Dataset
training_dataset = Groove2Groove2BarDataset(
    dataset_bz2_filepath="data/lmd/bass2drum.bz2pickle",
    subset_tag="train",
    max_len=32,
    tapped_voice_idx=2,
    augment_dataset=False,
...
from collections import Counter
Counter(training_dataset.genre_targets.numpy())
training_dataset.genre_targets
